...
for scan in scans:
    ...
    filename = root_folder + sample_name + str(scan) + "/data/mirror_ascan_mu_%05d.nxs"%scan
    f_copy = root_folder + sample_name + str(scan) + "/data/mirror_ascan_mu_%05d_R.nxs"%scan
