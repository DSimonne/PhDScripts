...
sample_name = "E"  # str or list of str of sample names (string in front of the scan number in the folder name).
...
background_file = "analysis/mask_merlin.npy"  # root_folder + 'background.npz'  # non empty file path or None
