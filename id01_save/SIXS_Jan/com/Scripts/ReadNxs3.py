...
class DataSet(object):
    ...
    def __init__(self,filename, directory = '', Nxs2Spec = False):
        ...
        try:
            #self._alias_dict = pickle.load(open('/home/david/Documents/PhD_local/PhDScripts/id01_save/SIXS_Jan/Pt_Al2O3/Scripts/analysis/alias_dict_2021.txt','rb'))
            self._alias_dict = pickle.load(open('/data/id01/inhouse/david/SIXS_Jan/com/Scripts/analysis/alias_dict_2021.txt','rb'))
