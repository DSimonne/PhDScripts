...
scans = 1305  # np.arange(1401, 1419+1, 3)  # list or array of scan numbers
# scans = np.concatenate((scans, np.arange(1147, 1195+1, 3)))
# bad_indices = np.argwhere(scans == 738)
# scans = np.delete(scans, bad_indices)

root_folder = "D:/Documents/PythonScripts/PhDLocalScripts/ScanSoleilGasatm"
