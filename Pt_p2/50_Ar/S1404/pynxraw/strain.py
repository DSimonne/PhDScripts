...
datadir = "/home/esrf/simonne/Documents/id01_david/Pt_p2/50_Ar/S1404/pynxraw/"
...
#########################################################
original_size = []  # size of the FFT array before binning. It will be modify to take into account binning
...
tilt_angle = 0.011  # angular step size for rocking angle, eta ID01, mu SIXS, does not matter for energy scan
